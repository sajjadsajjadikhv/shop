...
<head>
    ...
    <link href="/client/style/font-awesome.css" rel="stylesheet" type="text/css">
    <link href="/client/style/bootstrap.css" rel="stylesheet" type="text/css">
    <link href="/client/style/owl.carousel.css" rel="stylesheet" type="text/css">
    <link href="/client/style/owl.theme.default.css" rel="stylesheet" type="text/css">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="col-md-6">
                                <img src="/client/img/p20lite-listimage-black.png" class="w-75" >
                            </div>
                        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <div class="coopen">
                <img src="/client/img/coopen.png" class="w-100" />
            </div>
        </div>
        <div class="col-md-9">
            <div class="vizheh">
                <div class="col-md-6">
                    <div class="vizheh-img">
                        <img src="/client/img/p20lite-listimage-black.png" class="w-100" />
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="one-slider">
                ...
                <div class="owl-carousel owl-theme ov1">
                    <div class="item">
                        <figure>
                            <a href=""><img src="/client/img/Canon_EOS_400D.png" class="w-100" /></a>
                        </figure>
                        <h5>canon-ef-50mm</h5>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="book-baner">
                <a href="#"><img src="/client/img/book-baner.jpg" class="w-100" /></a>
        ...
        <div class="col-md-12">
            <div class="two-slider">
                ...
                <div class="owl-carousel owl-theme ov2">
                    <div class="item">
                        <figure>
                            <a href=""><img src="/client/img/p20lite-listimage-black.png" class="w-100" /></a>
                        </figure>
                        <h5>Samsung 500</h5>
                        <span>1,200,000 تومان</span>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="bodybulding-baner">
                <a href="#"><img src="/client/img/bodybulding-baner.jpg" class="w-100" /></a>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="blog-content">
                <figure>
                    <img src="/client/img/off/watch/1.jpg" class="w-100">
                </figure>
        ...
        <div class="row">
            <div class="tab-content">
                <div id="watch" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/watch/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/watch/1.jpg" class="w-100" /></a>
                    </div>
                ...
                <div id="badaligat" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/badal/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/badal/1.jpg" class="w-100" /></a>
                    </div>
                ...
                <div id="behdashti" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/behdashti/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/behdashti/1.jpg" class="w-100" /></a>
                    </div>
                ...
                <div id="bazi" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/bazi/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/bazi/1.jpg" class="w-100" /></a>
                    </div>
                ...
                <div id="varzesh" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/varzesh/8.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/varzesh/8.jpg" class="w-100" /></a>
                    </div>
                ...
                <div id="lebas" class="tab-pane fade">
                    <div class="col-md-3">
                        <a href="#"><img src="i/client/mg/off/lebas/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/lebas/1.jpg" class="w-100" /></a>
                    </div>
                    <div class="col-md-3">
                        <a href="#"><img src="/client/img/off/lebas/1.jpg" class="w-100" /></a>
                    </div>
...
<!---------------------------------->
<script src="/client/js/jquery-3.3.1.js" type="text/javascript"></script>
<script src="/client/js/jquery.simple.timer.js" type="text/javascript"></script>
<script src="/client/js/bootstrap.js" type="text/javascript"></script>
<script src="/client/js/owl.carousel.min.js" type="text/javascript"></script>
<script src="/client/js/js.js" type="text/javascript"></script>
</body>
</html>
